package com.example.ansh.modernnewsapp.ui.rvadapters

import android.support.v7.widget.RecyclerView
import android.view.LayoutInflater
import android.view.ViewGroup
import com.example.ansh.modernnewsapp.databinding.RvItemNewsBinding
import com.example.ansh.modernnewsapp.ui.uimodels.News

/**
 * Created by ansh on 13/02/18.
 */
class NewsRecylerViewAdapter(private var items: ArrayList<News>,
                             private var listener: OnItemClickListener)
    : RecyclerView.Adapter<NewsRecylerViewAdapter.ViewHolder>() {
